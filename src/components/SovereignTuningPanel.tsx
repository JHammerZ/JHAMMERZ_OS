...
export function SovereignTuningPanel({
  ...
  const [localNodesStatus, setLocalNodesStatus] = useState<Record<string, { latency: number; status: string; cdnSpeed: number }>>(() => {
    ...
    const nodeNames = [
      ...
      'youtube.com/@JHammerZ', 'instagram.com/jhammerzz', 'facebook.com/profile.php?id=61574652435664',
      'jhammerz.carrd.co', 'amazon.music/jhammerz', 'apple.music/jhammerz',
      'bandlab.com/jhammerz', 'xiaohongshu/jhammerz', 'github.com/JHammerZ/JHAMMERZ_OS',
  ...
  const nodeNamesList = [
    ...
    { key: 'node-6', name: 'facebook.com/profile.php?id=61574652435664', type: 'Social Validation Hub' },
    ...
    { key: 'node-12', name: 'github.com/JHammerZ/JHAMMERZ_OS', type: 'Sovereign Code Base' },
