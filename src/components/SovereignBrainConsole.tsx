...
export function SovereignBrainConsole({
  ...
  const [nodesRouteMapping, setNodesRouteMapping] = useState<any[]>(() => {
    ...
    return [
      ...
      { key: 'node-6', name: 'facebook.com/profile.php?id=61574652435664', endpoint: 'https://www.facebook.com/profile.php?id=61574652435664', type: 'Social Validation Hub', livePing: 82, secureKey: 'FB-98AA', activeChecking: false },
      ...
      { key: 'node-12', name: 'github.com/JHammerZ/JHAMMERZ_OS', endpoint: 'https://github.com/JHammerZ/JHAMMERZ_OS', type: 'Code Base Primary Server', livePing: 15, secureKey: 'GH-COMM', activeChecking: false },
  ...
  const [activeArchTab, setActiveArchTab] = useState<'disruptor' | 'wal' | 'reactor' | 'photonic' | 'homomorphic' | 'neuromorphic' | 'airgapped' | 'cognitive' | 'runtimes'>('disruptor');
